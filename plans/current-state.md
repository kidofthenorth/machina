...
`review-lens` (model: sonnet; untracked — `.claude/` is never staged). AGENTS.md's stale "M4 in
progress / 402 tests" status corrected. C8.5.1's executor seed prompt now lives in handoff.md.
