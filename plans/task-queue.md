...
| M4 | DOING | M4 | `crates/sweep` (+ portfolio/results/research-core additive) | parallel==sequential; repeated identical; holdout untouched | Plan: [m4-sweep.md](m4-sweep.md), 12 subtasks S1–S12. **S1–S10 DONE** (deterministic sweep core; S7 determinism gate; S8 walk-forward windows; S9 holdout gate; S10 cost/fee sensitivity ladder + cost-matched baselines — all adversarially reviewed). Next: S11 (advancement/rejection report + new sweep-report schema). S12 remains. 153 tests. |
